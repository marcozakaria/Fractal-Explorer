...
public class KochGeneratorAudio : MonoBehaviour
{
    ...
    public StartGeneration[] startGeneration;
    ...
    private void Awake()
    {
        ...
        {
            KochGenerate(targetPosition, startGeneration[i].outwards, startGeneration[i].scale);
        }
    }
